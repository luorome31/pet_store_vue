<template>
  <nav class="nav justify-content-center">
    ...
    <router-link v-if="!loginAccount" class="nav-link" to="/login"
      >Sign In</router-link
    >
    ...
    <div class="btn-group">
      ...
      <div
        class="dropdown-menu dropdown-menu-start text-center"
      ...
      >
        ...
        <router-link to="/products/bird" class="dropdown-item"
          >Bird</router-link
        >
        <router-link to="/products/fish" class="dropdown-item"
          >Fish</router-link
        >
      </div>
    </div>
